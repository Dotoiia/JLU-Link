	...
	const QString& msg)
{
	...
	const QString logRoot = QStandardPaths::writableLocation(QStandardPaths::AppLocalDataLocation);
	QDir dir(logRoot);
	dir.mkpath("logs");
...
int main(int argc, char *argv[])
{
	...
	a.setApplicationName("JLU Link");
	a.setApplicationDisplayName("JLU Link");
	a.setOrganizationName("Jilin University");
	a.setOrganizationDomain("jlu.edu.cn");
	...
	const QString screenshotPath = qEnvironmentVariable("DRCOM_SCREENSHOT_PATH");
